        ...
        <div className="relative overflow-hidden rounded-3xl bg-primary p-8 text-primary-foreground shadow-elegant md:p-14">
          ...
          <div className="relative grid items-center gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mt-3 max-w-md text-primary-foreground/75">Talk to a real travel specialist — average response time under two minutes, any time of day.</p>
            </div>
            <div className="flex flex-col gap-3 md:flex-row md:justify-end">
              <Button size="lg" className="rounded-xl bg-accent text-accent-foreground hover:bg-accent/90 hover:cursor-pointer">
